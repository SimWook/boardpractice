...
@Disabled("Spring Data REST が有効になっている場合のみ有効なテストです。")
@DisplayName("Data REST - API テスト")
@Transactional
...
public class DataRestTest {
    ...
    @DisplayName("[api] 記事リスト1件")
    @Test
    void articleOneTest() throws Exception {
    ...
    @DisplayName("[api] 会員関連APIは一切提供しない")
    @Test
    void gievenNothing() throws Exception {
